...
class CatBoost():
    def __init__(self, **params):
        ...
        if task == "outcome":
            ...
            self.model = CatBoostRegressor(random_state=seed, n_estimators=n_estimators, learning_rate=learning_rate, max_depth=max_depth, verbose=None, silent=True, allow_writing_files=False, loss_function="MAE")
        else:
